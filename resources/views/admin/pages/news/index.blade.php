        ...
        <section class="content">
            ...
            <div class="card">
                ...
                <div class="card-body p-0">
                    <a href="{{ route("news.create") }}" class="btn btn-primary btn-sm mt-3 mb-3 ml-3">Добавить новость</a>
                    @if($news->isNotEmpty())
                        <table class="table table-striped projects">
                            ...
                            @foreach($news as $new)
                                <tr>
                                    <td>
                                        <img style="width: 100%" src="{{ asset("storage/" . $new->img) }}">
                                    </td>
                                    <td>
                    ...
                    @else
                        <h3 class="ml-3">Список новостей пуст</h3>
                    @endif
                    <a href="{{ route("news.create") }}" class="btn btn-primary btn-sm mt-3 mb-3 ml-3">Добавить новость</a>
                </div>
                <!-- /.card-body -->
