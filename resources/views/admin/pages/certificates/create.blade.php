            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div id="actions" class="row">
                        <form method="post" id="addGallery" action="{{ route("certificate.store") }}" enctype="multipart/form-data">
                            @csrf
                        </form>
                        <div class="col-lg-6">
...
@section("scripts")
    ...
    <script src="{{ asset("assets/admin/js/components/addCertificate.js") }}"></script>
@endsection
