<div id="room1PopUp" class="modalForm">
    <div class="modal-content-form rooms__popup popup">
        ...
        <h2>РУССКАЯ ПАРНАЯ + БАССЕЙН</h2>
            ...
            <table>
                ...
                <tr>
                    <td>от 500 ₽ за человека/ 1 час*</td>
                    <td>от 550 ₽ за человека/1 час*</td>
                </tr>

            </table>
            <p>* Стоимость зависит от продолжительности и количества человек. Более подробную информацию можно получить
                по телефону кассы (8 83147) 7 65 26 или здесь <a href="{{ asset("storage/downloads/documents/doc-2.pdf") }}">(ссылка на постановление)</a></p>
